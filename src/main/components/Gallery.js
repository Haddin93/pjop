          ...
          <Row>
            <Col>
                <div ref={galleryRef} className="text-center">
                  <a className="img-ho">                   
                  <Image
                src={require("../assets/images/team/image1.jpg")}
            ...
            <Col>
                <div className="text-center">
                  ...
                  <Image
                src={require("../assets/images/team/image2.jpg")}
                className="custom-pjop" style={{width : "416px" , height: "300px"}}
              ></Image>
                  </a>
                </div>
            ...
            <Col>
                <div className="text-center">
                  <a href="#" className="img-ho">
                  <Image
                src={require("../assets/images/team/image3.jpg")}
                className="custom-pjop" style={{width : "416px" , height: "300px"}}
              ></Image>
                  </a>
                </div>
            ...
            <Col>
                <div className="text-center">
                  <a href="#" className="img-ho">
                  <Image
                src={require("../assets/images/team/image4.jpg")}
                className="custom-pjop" style={{width : "416px" ,  height: "300px"}}
              ></Image>
                  </a>
                </div>
            ...
            <Col>
                <div className="text-center">
                  <a href="#" className="img-ho">
                  <Image
                src={require("../assets/images/team/image5.jpg")}
                className="custom-pjop" style={{width : "416px",  height: "300px"}}
              ></Image>
                  </a>
                </div>
            ...
            <Col>
                <div className="text-center">
                  <a href="#" className="img-ho">
                  <Image
                src={require("../assets/images/team/image6.jpg")}
                className="custom-pjop" style={{width : "416px",  height: "300px"}}
              ></Image>
                  </a>
                </div>
          ...
          <Row>
            <Col>
                <div className="text-center">
                  <a href="#" className="img-ho">
                  <Image
                src={require("../assets/images/team/image7.jpg")}
                className="custom-pjop" style={{width : "416px",  height: "300px"}}
              ></Image>
                  </a>
                </div>
            ...
            <Col>
                <div className="text-center">
                  <a href="#" className="img-ho">
                  <Image
                src={require("../assets/images/team/image8.jpg")}
                className="custom-pjop" style={{width : "416px",  height: "300px"}}
              ></Image>
                  </a>
                </div>
            ...
            <Col>
                <div className="text-center">
                  <a href="#" className="img-ho">
                  <Image
                src={require("../assets/images/team/image9.jpg")}
                className="custom-pjop" style={{width : "416px",  height: "300px"}}
              ></Image>
                  </a>
                </div>
          ...
          <Row>
            <Col>
                <div className="text-center">
                  <a href="#" className="img-ho">
                  <Image
                src={require("../assets/images/team/image10.jpg")}
                className="custom-pjop" style={{width : "416px",  height: "300px"}}
              ></Image>
                  </a>
                </div>
            ...
            <Col>
                <div className="text-center">
                  <a href="#" className="img-ho">
                  <Image
                src={require("../assets/images/team/image11.jpg")}
                className="custom-pjop" style={{width : "416px",  height: "300px"}}
              ></Image>
                  </a>
                </div>
            ...
            <Col>
                <div className="text-center">
                  <a href="#" className="img-ho">
                  <Image
                src={require("../assets/images/team/image12.jpg")}
                className="custom-pjop" style={{width : "416px",  height: "300px"}}
              ></Image>
                  </a>
                </div>
          ...
          <Row>
            <Col>
                <div className="text-center">
                  <a href="#" className="img-ho">
                  <Image
                src={require("../assets/images/team/image13.jpg")}
                className="custom-pjop" style={{width : "416px",  height: "300px"}}
              ></Image>
                  </a>
                </div>
            ...
            <Col>
                <div className="text-center">
                  <a href="#" className="img-ho">
                  <Image
                src={require("../assets/images/team/image14.jpg")}
                className="custom-pjop" style={{width : "416px", height: "300px"}}
              ></Image>
                  </a>
                </div>
            ...
            <Col>
                <div className="text-center">
                  <a href="#" className="img-ho">
                  <Image
                src={require("../assets/images/team/image15.jpg")}
                className="custom-pjop" style={{width : "416px", height: "300px"}}
              ></Image>
                  </a>
                </div>
          ...
          <Row>
            <Col>
                <div className="text-center">
                  <a href="#" className="img-ho">
                  <Image
                src={require("../assets/images/team/image16.jpg")}
                className="custom-pjop" style={{width : "416px", height: "300px"}}
              ></Image>
                  </a>
                </div>
            ...
            <Col>
                <div className="text-center">
                  <a href="#" className="img-ho">
                  <Image
                src={require("../assets/images/team/image17.jpg")}
                className="custom-pjop" style={{width : "416px", height: "300px"}}
              ></Image>
                  </a>
                </div>
            ...
            <Col>
                <div className="text-center">
                  <a href="#" className="img-ho">
                  <Image
                src={require("../assets/images/team/image18.jpg")}
                className="custom-pjop" style={{width : "416px", height: "300px"}}
              ></Image>
                  </a>
                </div>
          ...
          <Row>
            <Col>
                <div className="text-center">
                  <a href="#" className="img-ho">
                  <Image
                src={require("../assets/images/team/image19.jpg")}
                className="custom-pjop" style={{width : "416px", height: "300px"}}
              ></Image>
                  </a>
                </div>
            ...
            <Col>
                <div className="text-center">
                  <a href="#" className="img-ho">
                  <Image
                src={require("../assets/images/team/image20.jpg")}
                className="custom-pjop" style={{width : "416px", height: "300px"}}
              ></Image>
                  </a>
                </div>
            ...
            <Col>
                <div className="text-center">
                  <a href="#" className="img-ho">
                  <Image
                src={require("../assets/images/team/image21.jpg")}
                className="custom-pjop" style={{width : "416px", height: "300px"}}
              ></Image>
                  </a>
                </div>
          ...
          <Row>
            <Col>
                <div className="text-center">
                  <a href="#" className="img-ho">
                  <Image
                src={require("../assets/images/team/image22.jpg")}
                className="custom-pjop" style={{width : "416px", height: "300px"}}
              ></Image>
                  </a>
                </div>
            ...
            <Col>
                <div className="text-center">
                  <a href="#" className="img-ho">
                  <Image
                src={require("../assets/images/team/image23.jpg")}
                className="custom-pjop" style={{width : "416px", height: "300px"}}
              ></Image>
                  </a>
                </div>
            ...
            <Col>
                <div className="text-center">
                  <a href="#" className="img-ho">
                  <Image
                src={require("../assets/images/team/image24.jpg")}
                className="custom-pjop" style={{width : "416px", height: "300px"}}
              ></Image>
                  </a>
                </div>
